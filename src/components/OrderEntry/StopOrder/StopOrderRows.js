...
export const StopOrderRows = ({
    ...
    return (
        <Wrapper>
            ...
            >
                {value =>
                    <Row header={value} amount={amount} coin={amountCoin} onChange={handleAmountChange} darkBg={isBuy} />
                }
            </FormattedMessage>
            <FormattedMessage
            ...
            >
                {value =>
                    <Row header={value} readOnly={true} amount={total} coin={totalCoin} darkBg={!isBuy} />
                }
            </FormattedMessage>
        </Wrapper>
    );
