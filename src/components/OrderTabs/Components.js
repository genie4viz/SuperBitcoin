...
export const FormHeader = styled.div`
    ...
    padding-left: 14px;
    padding-right: 6px;
    border-bottom: 1px solid ${props => props.theme.palette.orderFormInputBorder};
...
export const Dropdown = styled.div`
    ...
    transform: translateY(${props => props.isHovered ? '0px' : '20px'});
...
export const Item = styled.div`
    color: ${props =>
        props.active ? props.theme.palette.orderFormHeaderTabActiveText : props.isHovered ? props.theme.palette.clrHighContrast : props.theme.palette.clrPurple};
    cursor: pointer;
    white-space: nowrap;
