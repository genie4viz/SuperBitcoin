            ...
            <Wrapper>
                <InputWrapper className={`phone-number-input ${currentView}`}>
                    ...
                    {!isPhoneNumberSent && (
                        <InputAddon
                            onClick={
                                !phoneNumber ? handleBack : isSendingPhoneNumber ? null : this.handleSendPhoneNumber
                            }
                        >
                    ...
                    <InputWrapper className={`code-input ${currentView} ${codeInputClassForValid}`}>
...

                        {
                            <InputAddon onClick={isSendingCode ? noop : this.handleCheckCode}>
                                {isSendingCode ? <SpinnerIcon /> : (isCodeValid && currentView === SMS_AUTH_VIEW_STEPS.VERIFY_SUCCESS) ? <SpinnerIcon /> : <SendIcon />}
                            </InputAddon>
                        }
                    </InputWrapper>
                )}
