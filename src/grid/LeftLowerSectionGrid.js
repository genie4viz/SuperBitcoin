...
import ArbOrderEntryForm from '@/components/OrderEntry/ArbOrder';
...
const MARKET_LIST = [
    ...
    [
        <FormattedMessage
            id="grid.label_amount_fixed"
            defaultMessage="Fixed"
        />,
        <FormattedMessage
            id="grid.label_arbitrage_unfixed"
            defaultMessage="Arbitrage - Unfixed"
        />
    ] */
];
...
const LeftLowerSectionGrid = ({
    ...
    const MarketTabs = () => {
        return (
            <OrderTabs tabs={MARKET_LIST} subtabs={MARKET_SUB_LIST} setArbMode={setArbMode} setTradingViewMode={setTradingViewMode}>
                ...
                <BuySellOrderWrapper id="buy-sell-wrapper-arb">
                    <ArbOrderEntryForm showModal={showModal} />
                </BuySellOrderWrapper>                
            </OrderTabs>
        );
    };
...
export default compose(
    inject(STORE_KEYS.VIEWMODESTORE, STORE_KEYS.MARKETMAKER, [STORE_KEYS.ORDERENTRY]),
    observer
