...
const ConnectionLost = ({
    ...
    const isConnected = isPublicConnected && (!isLoggedIn || isPrivateConnected);
...
export default inject(STORE_KEYS.NETWORKSTORE, STORE_KEYS.TELEGRAMSTORE)(observer(ConnectionLost));
