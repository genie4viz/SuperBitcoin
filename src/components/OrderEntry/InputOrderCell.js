...
const Wrapper = styled.div`
    ...
    border: 1px solid ${props => props.theme.palette.orderFormInputBorder};
    border-radius: 0;
    font-size: 16px;
    font-weight: 600;
    position: relative;
    ...
    [data-text] {
        ...
        background-image:  ${props => props.isBuy ? 
            `linear-gradient(${props.theme.palette.clrGreen}, ${props.theme.palette.clrGreen})` : 
            `linear-gradient(${props.theme.palette.btnNegativeBg}, ${props.theme.palette.btnNegativeBg})`
        };
    ...
    .slider {
        ...
        &:after {
            ...
            background: ${props => {
                ...
                return props.isBuy ? props.theme.palette.clrGreen : props.theme.palette.btnNegativeBg
            }};
        }
    }
