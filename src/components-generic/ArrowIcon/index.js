...
const ArrowIconSvg = styled.svg`
    ...
    fill: ${props => props.isBuy ? props.theme.palette.coinPairBuyArrow : props.theme.palette.coinPairSellArrow};
    text {
        font-weight: bold;
        font-size: 16px;
        text-anchor: start;
...
export const CaretArrowIcon = props => (
    <CaretArrowIconSvg {...props} viewBox="0 0 320 512">
        <g>
            <path fill={props.fillColor ? props.fillColor : "white"}
