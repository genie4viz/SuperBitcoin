...
export const SETTING_TIPPY_INFO  = {
    ...
    REPORT_ACCOUNTS: 'View Accounts',
    REPORT_ORDER_HISTORY: 'Click to view Order History',
    REPORT_TRADE_HISTORY: 'Click to view Trade History',
    REPORT_PAYMENT_HISTORY: 'Click to view Payment History',
    REPORT_NAV_HISTORY: 'Click to view NAV Report',
    PREFERENCE_ACTIVE_ORDERS: 'View Active Orders',
    PREFERENCE_FILLED_ORDERS: 'View Filled and Cancelled Orders',
    REPORT_MY_TRADES: 'View your Trades',
    PREFERENCE_DEPTH_CHART: 'View Market Depth Chart',
};

// Makes OrderBook update slower in development
export const ORDER_BOOK_THROTTLE = process.env.NODE_ENV === 'production' ? 250 : process.env.REACT_APP_ORDER_BOOK_THROTTLE;

// Used to filter un-supported exchanges from the UI
// Eventually the BE should provide an API point which
// returns list of supported exchanges for the FE
export const ACCEPTED_EXCHANGES = [
  "Bitfinex",
  "Bitstamp",
  "Ethfinex",
  "HitBTC",
