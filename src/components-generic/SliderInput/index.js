...
const SliderWrapper = styled.div.attrs({ className: 'slider-input' })`
    ...
    input[type='range'] {
        ...
        &::-webkit-slider-thumb {
            ...
            border: 1px solid
                ${props =>
                    (props.colors && props.colors.ctrlSliderThumbBorder) || props.theme.palette.ctrlSliderThumbBorder};
            background: ${props =>
                (props.colors && props.colors.ctrlSliderThumbBg) || props.theme.palette.ctrlSliderThumbBg};
            cursor: pointer;
        }
        ...
        input[type='range'] {
            &::-webkit-slider-thumb {
                background: ${props =>
                    ...
                    props.theme.palette.ctrlSliderThumbHoverBg};
                border-color: ${props =>
                    (props.colors && props.colors.ctrlSliderThumbHoverBorder) ||
                    props.theme.palette.ctrlSliderThumbHoverBorder};
            }
        ...
        input[type='range'] {
            &::-webkit-slider-thumb {
                background: ${props =>
                    ...
                    props.theme.palette.ctrlSliderThumbActiveBg};
                border-color: ${props =>
