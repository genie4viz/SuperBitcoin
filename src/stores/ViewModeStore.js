...
class ViewModeStore {
    ...
    @observable rightBottomSectionOpenMode = MODE_KEYS.depthChartKey; // default is my trades mode
    ...
    @observable showColdStorage = false;
    ...
    @action.bound setRightBottomSectionOpenMode(mode) {
        ...
        if (this.rightBottomSectionOpenMode !== mode) {
            const dontGoFullScreenModes = [MODE_KEYS.depthChartKey, MODE_KEYS.activeModeKey, MODE_KEYS.filledModeKey, MODE_KEYS.myTradesModeKey, MODE_KEYS.myPortfolioModeKey];
    ...
    @action.bound setColdStorageMode(mode) {
        this.showColdStorage = mode;
    }
