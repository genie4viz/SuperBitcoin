            ...
            >
                {value =>
                    <StopOrderContainer
                        ...
                        orderButtonText={arbHFMode ? <div>{quoteSymbol} <LimitOrderArrow isBuy /> {baseSymbol}</div> : `${value} ${baseSymbol}`}
                        isBuy={true}
            ...
            >
                {value =>
                    <StopOrderContainer
                        ...
                        total={sellTotal}
                        totalCoin={quoteSymbol}
                        orderButtonText={arbHFMode ? <div>{baseSymbol} <LimitOrderArrow /> {quoteSymbol}</div> : `${value} ${baseSymbol}`}
                        isBuy={false}
