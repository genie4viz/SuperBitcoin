...
class PriceChartStore {
    ...
    constructor(instrumentStore, settingsStore, marketsStore, yourAccountStore, fiatCurrencyStore, orderBookBreakDownStore) {
    ...
    fetchFiatPrice = async () => { // Todo: We will use FiatCurrencyStore instead of direct access here
    ...
    getPriceOf = (symbol) => { // Todo: We will use FiatCurrencyStore instead of direct access here
    ...
    @action.bound getStockPriceOf = (symbol) => { // Todo: We will use FiatCurrencyStore instead of direct access here
    ...
    fetchSpPrice = () => {
        const ePrice = this.getPriceOf('F:EUR');
        this.usdOfBTC = this.getPriceOf('BTC');
        this.euroOfBTC = this.usdOfBTC / ePrice;
    };
}

export default (instrumentStore, settingsStore, marketsStore, yourAccountStore, fiatCurrencyStore, orderBookBreakDownStore) =>
    new PriceChartStore(instrumentStore, settingsStore, marketsStore, yourAccountStore, fiatCurrencyStore, orderBookBreakDownStore);
