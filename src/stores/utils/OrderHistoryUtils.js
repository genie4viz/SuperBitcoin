...
import {
    getDateFormatted, getNewDateFormatted, getTimeFormatted, formatNumForDisplay
} from './storeUtils';
import {
    sortObjectArray, customDigitFormat
} from '../../utils';
...
export const mapTradeHistoryForDisplay = (Orders) =>
    Orders.map(({
        OriginalSize, Amount, Price, SentTime, Symbol, Side, Exchange, TicketId,
    }) => {
        try {
