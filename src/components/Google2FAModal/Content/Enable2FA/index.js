...
function Enable2FA(props) {
    ...
    return (
        <InnerWrapper>
            <TextTitle>
                <FormattedMessage
                    id="modal.2fa.label_enable_google"
                    defaultMessage="Enable Google 2-Step Authentication"
                />
            </TextTitle>

            <TextDescription>
                <FormattedMessage
                    id="modal.2fa.label_notice"
                    defaultMessage="Use Google Authenticator App"
                />
            </TextDescription>
            ...
            <InputWrapper>
                <FormattedMessage
                    id="modal.2fa.label_input_one_time_password"
